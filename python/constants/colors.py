...
if __name__ == "__main__":
    ...
    print(
        f"{PathWiseColors.JUMP_BRACKET}[j1]{PathWiseColors.RESET} ~/projects/pathwise"
    )
    print(
        f"{PathWiseColors.TIME_VERY_HIGH}(5 visits · 2h 34m today){PathWiseColors.RESET}"
    )
