...
TIPS = {
    "pathwise": [
        "Use 'j1' through 'j5' to jump to your most visited directories instantly",
        "Run 'freq --insights' to see detailed analytics about your navigation patterns",
        "PathWise tracks time automatically - stay in a directory 5+ seconds to record it",
        "Use 'freq --config' to customize tracking settings and display preferences",
        "Your jump shortcuts update dynamically as your habits change throughout the day",
        "Run 'freq --reset' to clear all data and start fresh with new tracking",
